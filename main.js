...
function main () {
  ...
  let objects = [
    ...
    createSphere([-1.5,2.5,0.0],0.5,createMaterial([1.0,1.0,1.0],0.1,0.5,50.0,0.1)),  // metal
    createSphere([-1.5,1.0,0.0],1.0,createMaterial([1.0,0.0,0.0],0.8,0.3,50.0,0.8)),  // orn
    createSphere([1.5,1.0,0.0],1.0,createMaterial([0.0,1.0,0.0],0.8,0.3,50.0,0.8)),   // orn
    createSphere([0.0,1.0,-2.0],1.0,createMaterial([0.0,0.0,1.0],0.8,0.3,50.0,0.8)),  // orn
