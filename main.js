...
function main () {
  ...
  let objects = [
    ...
    createSphere([-1.5,2.5,0.0],0.5,createMaterial([1.0,1.0,1.0],0.2,0.5,50.0,0.1)),  // metal
    ...
    createSphere([ 0.0,0.5,2.0],0.5,createMaterial([1.0,1.0,1.0],0.6,0.2,5.0,0.0)),   // matte
