...
createSphere([0.0,-5000.0,0.0],5000,createMaterial([1.0,1.0,1.0],1.0,0.5,10.0, 0.3)),
  ...
  if (hit.m.di > 0) {
    ...
    if (diffuse_intensity > 0) {
      ...
      if (i == objs.length) {
        ...
        diffuse_intensity = 1 - diffuse_intensity * hit.m.di * (diffuse_intensity - specular_intensity) * hit.m.si;
